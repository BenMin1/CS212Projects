...
public class Date212{
    ...
    //Use selection sort to return a sorted list of dates 
    public static Date212[] compareTo (Date212[] array) {
        ...
        for ( int i = 0; i < length - 1; i++ ) {
            ...
            for ( int j = i + 1; j < length; j++ ){
                ...
                //Set indexLowest to the earliest date
                if ( array[j].year < array[indexLowest].year ) 
                    indexLowest = j;
                if ( array[j].year == array[indexLowest].year && array[j].month < array[indexLowest].month) 
                    indexLowest = j;           
                if ( array[j].year == array[indexLowest].year && array[j].month == array[indexLowest].month && array[j].day < array[indexLowest].day) 
                    indexLowest = j;             
            }//for j

            //Swap lowest to the front of the array
